...
mobile_user_agent = "Mozilla/5.0 (Linux; Android 13; NOH-AN50) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/106.0.0.0 Mobile Safari/537.36"
...
try:
    ...
    driver.add_cookie({'name': 'PHPSESSID', 'value': 'e58590e43fecd3a12a03d1565d41420a'})
    time.sleep(2)
    # to refresh the page
    driver.refresh()
